...
@SpringBootTest
@Testcontainers
class SpringBootTestcontainersDemo1ApplicationTests {
    @Container
    ...
    static void registerDynamicProperties(DynamicPropertyRegistry registry) {
        DemoApplicationTestPropertyValues.populateRegistryFromContainers(registry, postgreSQLContainer, activemq,
                rabbitmq);
    }
